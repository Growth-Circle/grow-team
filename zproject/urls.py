...
from zerver.views.agent_devices import (
    ...
    list_setups_device,
    pairing_status_device,
    register_workspace_device,
...
v1_api_and_json_patterns = [
    ...
    rest_path("agent/profiles/recover", GET=recover_agent_profile),
    rest_path(
        "agent/profiles/<uuid:profile_id>", GET=get_agent_profile, PATCH=update_agent_profile
    ),
    rest_path("agent/pairings/approve", POST=approve_agent_pairing),
    rest_path("agent/runners", GET=list_agent_runners),
    rest_path("agent/runners/<uuid:runner_id>", GET=get_agent_runner),
    rest_path("agent/runners/<uuid:runner_id>/metadata", PATCH=update_agent_runner_metadata),
    rest_path("agent/team-default", GET=get_team_default, PATCH=update_team_default),
    rest_path("agent/selection/resolve", POST=resolve_team_agent_selection),
    rest_path("agent/runners/<uuid:runner_id>/revoke", POST=revoke_agent_runner),
    rest_path("agent/providers", GET=list_agent_providers, POST=create_agent_provider),
    rest_path(
        "agent/providers/<uuid:provider_id>", GET=get_agent_provider, PATCH=update_agent_provider
    ),
    rest_path("agent/providers/<uuid:provider_id>/probe", POST=create_provider_probe_view),
    rest_path("agent/repositories", GET=list_agent_repositories, POST=create_agent_repository),
    rest_path("agent/repositories/<uuid:repository_id>", GET=get_agent_repository),
    ...
    rest_path("agent/grants", GET=list_agent_grants, POST=create_agent_grant_view),
...
urls += [
    ...
    path("api/v1/agent/runner/authority", agent_runner_views.authority),
    path("api/v1/agent/runner/credential-access", agent_runner_views.credential),
    path("api/v1/agent/runner/setup-authority", agent_runner_views.probe_authority),
    ...
    path("api/v1/agent/pairings/status", pairing_status_device),
    path("api/v1/agent/runner/workspaces", register_workspace_device),
    path("api/v1/agent/runner/token/refresh", rotate_device_credential),
    path("api/v1/agent/runner/catalog", update_runner_catalog),
    path("api/v1/agent/runner/metadata", agent_runner_views.metadata),
