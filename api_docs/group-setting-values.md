...
Settings defining permissions in Grow Team are increasingly represented
...
!!! warn ""
    ...
    **Changes**: Before Grow Team 10.0 (feature level 309), only system
...
The Grow Team server maintains a collection of system groups that
...
The following system groups are maintained by the Grow Team server:
...
The Grow Team API uses a special format for modifying an existing setting
