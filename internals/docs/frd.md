...
| FR-10 | Jalur dan provider | Jalur cepat (Anthropic SDK, answer dan manage) dan jalur code (container, ACP) memakai kontrak berbeda. Provider dipilih eksplisit dari konfigurasi yang diuji. | Ada di source. Jangan gunakan fallback atau switch jalur otomatis. |
