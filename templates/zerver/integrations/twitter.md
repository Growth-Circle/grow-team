Fetch tweets from Twitter in Grow Team! This is great for seeing and
...
1.  When someone tweets a message containing one of your search terms,
    get a Grow Team on your specified stream, with the search term as
    the topic.
...
`/etc/zulip/settings.py` on the Grow Team server.
