...
<Tabs>
  <TabItem label="Mobile">
    <FlattenedSteps>
      ...
      1. Tap on the desired Grow Team organization.
    </FlattenedSteps>
  </TabItem>
  ...
  <TabItem label="Web">
    You can log in to multiple Grow Team organizations by opening multiple tabs, and
    logging into one Grow Team organization in each tab. To switch Grow Team organizations,
    just switch tabs.
  </TabItem>
</Tabs>
