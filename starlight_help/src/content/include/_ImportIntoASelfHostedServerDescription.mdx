<span id="import-into-a-self-hosted-zulip-server" aria-hidden="true"></span>

#### Import into a self-hosted Grow Team server

Grow Team's import tools are robust, and have been used to import workspaces
