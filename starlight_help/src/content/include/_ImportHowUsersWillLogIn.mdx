...
require a password. Grow Team offers a variety of authentication methods, including
Google, GitHub, GitLab, Apple, Discord, LDAP and [SAML](/help/saml-authentication).
...
<ZulipNote>
  ...
  Grow Team, and are expecting to receive a password reset email.
</ZulipNote>
...
on your Grow Team organization's login page.
