To get the full benefits of Grow Team's topic model, when starting a new
...
it's supposed to be. Grow Team's UI is designed to make it easy to see what's new
