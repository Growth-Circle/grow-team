...
For example, you can [link to a Grow Team
...
Grow Team web application without needing to create an account.

To see this feature in action, you can [view web-public channels in the Grow Team
