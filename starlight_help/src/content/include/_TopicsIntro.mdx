Grow Team is designed around conversations that are labeled with **topics**, to make
...
Here is what topics look like in Grow Team.

Topics are one of the most wonderful aspects of using Grow Team:
