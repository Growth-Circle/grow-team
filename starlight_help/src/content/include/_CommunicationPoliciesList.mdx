* Many organizations find that with Grow Team, there’s no longer a reason to use
  ...
  @-mentions, and more.
* Because Grow Team further organizes messages into conversations labeled with
...
* With conversations organized by topic, you can review prior discussions to
  ...
  becomes a knowledge base. Should it be standard practice to link to Grow Team
  conversations from docs, issue trackers, etc. for additional context?
* Using Grow Team, you can discuss complex topics and make decisions with input
