...
users joining your organization. This lets you customize the Grow Team experience to
match how your organization is using Grow Team.
...
the default language for new users when Grow Team cannot detect their language
preferences from their browser, including all users [created via the Grow Team
API](/api/create-user).
