...
To import your Slack organization into Grow Team, you will need to take the
following steps, which are described in more detail below:

<Steps>
  1. [Export your Slack data](#export-your-slack-data).
  1. [Import your Slack data into Grow Team](#import-your-data-into-zulip).
...
<span id="import-your-organization-from-slack-into-zulip" aria-hidden="true"></span>

## Import your organization from Slack into Grow Team
  ...
  <TabItem label="Zulip Cloud (self-serve)">
    <Steps>
      ...
      1. If you're using a different registration email from your Slack account,
         ...
         account in the imported workspace, you can create a new Grow Team account.
      1. Set a password for your Grow Team account, and click **Submit**.
    </Steps>
  </TabItem>
...
* Slack's user roles are mapped to Grow Team's [user
  roles](/help/user-roles) in the following way:
  | Slack role              | Grow Team role    |
  | ----------------------- | ------------- |
...
To prepare your organization for transitioning to Grow Team, follow the [guide on
