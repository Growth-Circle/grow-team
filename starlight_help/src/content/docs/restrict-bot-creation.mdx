...
Grow Team lets you create three types of [bots](/help/bots-overview):

* **Incoming webhook bots**, which are limited to only sending messages into Grow Team.
...
<FlattenedSteps>
  ...
  1. Under **Other permissions**, configure **Who can create bots that send messages into Grow Team**.
