...
Grow Team uses Markdown to allow you to easily format your messages. Even if you've
...
overview of all the formatting available in Grow Team. There is a convenient
[message formatting reference](#message-formatting-reference) in the Grow Team
...
A summary of the formatting syntax above is available in the Grow Team app.
