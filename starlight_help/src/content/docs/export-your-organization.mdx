...
<ZulipNote>
  If you're self-hosting Grow Team, you may want to check out the
  documentation on [server export and import][export-and-import] or
  [server backups][production-backups].
</ZulipNote>

Grow Team has high quality export tools that can be used to migrate between the
  ...
  <TabItem label="Desktop/Web">
    <FlattenedSteps>
      ...
      1. Click **Start export** to begin the export process. After a few minutes,
         ...
         data exports.
      1. Use [Grow Team's logical data import tool][import-only] to import your data into
...
If you self-host Grow Team, an export of all public and private data can be performed
...
importing the export into a new Grow Team organization.
...
<Steps>
  1. Email [support@zulip.com](mailto:support@zulip.com) asking for a **compliance
     ...
     to Grow Team, so that your server administrator can verify that you are an owner of the
...
If you self-host Grow Team, a compliance export can be performed [by your server's
...
* [Import organization into a self-hosted Grow Team server][import-only]
