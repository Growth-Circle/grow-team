...
By default, Grow Team limits the width of the center message pane, because it's
...
You can instead configure Grow Team to use the full width of wide screens.
