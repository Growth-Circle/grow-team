...
<FlattenedSteps>
  ...
  1. Take advantage of Grow Team's [native integrations ecosystem](/integrations) by
     connecting Grow Team with the tools you use.
</FlattenedSteps>
...
<FlattenedList>
  ...
  * In Grow Team, it's easy to have many conversations in parallel without losing
    ...
    DMs.
  * Grow Team allows users to fine-tune their notification settings. Make sure you're
