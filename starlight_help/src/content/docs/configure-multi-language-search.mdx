...
Grow Team supports [full-text search](/help/search-for-messages), which can be
combined arbitrarily with Grow Team's full suite of [search
filters](/help/search-for-messages#search-filters). By default, Grow Team search
...
Self-hosted Grow Team organizations can instead set up an experimental
