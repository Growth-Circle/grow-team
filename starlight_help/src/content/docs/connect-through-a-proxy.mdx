...
Some corporate and university networks may require you to connect to Grow Team
via a proxy.

## Web

Grow Team uses your browser's default proxy settings. To set a custom proxy just
for Grow Team, check your browser's instructions for setting a custom proxy for
a single website.
...
<Tabs>
  <TabItem label="System proxy settings">
    <FlattenedSteps>
      ...
      1. Restart the a compatible desktop client.
    </FlattenedSteps>
  </TabItem>
