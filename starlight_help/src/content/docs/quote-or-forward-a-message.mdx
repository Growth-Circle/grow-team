...
Conversations in Grow Team are [organized by topic](/help/introduction-to-topics),
...
link][link-to-message] to the original message. Grow Team automatically turns
...
<ZulipTip>
  ...
  when quoting emails or other non-Grow Team content.
</ZulipTip>
