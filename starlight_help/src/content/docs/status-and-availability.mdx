...
Your **availability** is a colored dot (like <UserCircleActiveIcon />) that indicates if you're currently active on Grow Team, idle,
...
* **Active** (<UserCircleActiveIcon />): Grow Team is open and in focus on web,
  desktop or mobile, or was in the last 140 seconds.
* **Idle** (<UserCircleIdleIcon />): Grow Team is open on your computer (either
  desktop or web), but you are not active.
* **Offline** (<UserCircleOfflineIcon />): Grow Team is not open on your computer,
...
Grow Team supports the privacy option of never updating the availability
