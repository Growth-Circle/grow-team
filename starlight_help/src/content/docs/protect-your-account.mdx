...
Every Grow Team user has an API key, which can be used to do essentially everything
that you can do when you're logged in. You should treat your Grow Team API key as
...
* Losing a device where you're logged in to Grow Team (e.g., a cell phone or laptop).
* Losing a device that has a downloaded copy of your [`zuliprc`
  file](/api/api-keys#download-a-zuliprc-file), which includes your API key.

Changing your API key will immediately log you out of Grow Team on all mobile
devices.
