...
<ZulipNote>
  Organization admins can always edit message topics and move topics between
  channels via the API.
</ZulipNote>

Grow Team lets you configure who can edit message topics and move topics between
