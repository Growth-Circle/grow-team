...
Grow Team's compose box has a smart **math (LaTeX)** (<MathIcon />) button,
...
<span id="copy-latex-from-a-message-in-zulip" aria-hidden="true"></span>

### Copy LateX from a message in Grow Team

Grow Team supports [quoting](/help/quote-or-forward-a-message#quote-a-message),
...
<ZulipTip>
  If you select part of a math expression to copy, Grow Team will automatically
...
* Allow MathML annotations to be included in HTML copied by the browser (for
  Grow Team, this was [a couple lines of
