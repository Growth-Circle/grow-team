...
Each user can use Grow Team with [their preferred language][user-lang].
...
* Is used as the default language for new user accounts when Grow Team
  cannot detect their language preferences from their browser,
  including all users [created via the Grow Team API][api-create-user].
