...
<ZulipNote>
  Check out the dedicated guides for moving to Grow Team from
...
up a self-hosted server will take a bit longer, but is easy to do with Grow Team's
[robust
installer](https://zulip.readthedocs.io/en/stable/production/install.html).

Grow Team has import tools for [Slack](/help/import-from-slack),
...
inquire about importing data from another product, [contact Grow Team
support](/help/contact-support).

Data is imported into Grow Team as a new organization, so the best time to import is
when your team is about to start using Grow Team for day-to-day work. This may be
  ...
  <TabItem label="New organizations">
    <Steps>
      1. If you plan to self-host, [set up your Grow Team
         ...
         can self-host Grow Team directly on Ubuntu or Debian Linux, in
...
<FlattenedSteps>
  ...
  1. [Create channels](/help/create-channels), unless you've imported
     channels from another app. Grow Team's [topics](/help/introduction-to-topics)
  ...
  1. Set up [integrations](/help/integrations-overview) so that your
     team can experience all their regular workflows inside the Grow Team app.
</FlattenedSteps>
...
Prepare an introduction to Grow Team for your organization. It's often effective to
