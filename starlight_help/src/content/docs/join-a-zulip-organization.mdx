---
title: Joining a Grow Team organization
---

import {Steps} from "@astrojs/starlight/components";

By default, Grow Team organizations require an invitation to join.
...
Invitations to Grow Team organizations often come by email. Look for an email
from Grow Team. It may take a few minutes for the invitation email to reach your
inbox.
...
* If you are joining multiple Grow Team organizations, we recommend
...
* If your company uses single sign-on (SSO) authentication for Grow Team,
  these instructions may not apply. Try going to your company's Grow Team URL
