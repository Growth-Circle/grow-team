...
The Grow Team sends automated notices via Notification Bot to notify users about
...
configure what channel Grow Team uses for these notices, or disable these notices
...
You can configure whether Grow Team will send an automated message when a channel's
...
<span id="zulip-update-announcements" aria-hidden="true"></span>

## Grow Team update announcements

Grow Team announces new features and other important product changes via automated
messages. This is designed to help users discover new features they may find
useful, including new configuration options.

These announcements are posted to the “Grow Team updates” topic in the
...
On self-hosted Grow Team servers, announcement messages are shipped with the Grow Team
...
Unlike other notices, Grow Team update announcements are not translated.

<span id="configure-zulip-update-announcements" aria-hidden="true"></span>

### Configure Grow Team update announcements
...
<FlattenedSteps>
  ...
  1. Under **Automated messages and emails**, configure **Grow Team update
     announcements**.
