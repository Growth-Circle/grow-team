...
invited to a company's Grow Team chat.
...
Grow Team can display a warning to let users know when recipients for a direct
...
* The user does not appear in typeahead suggestions, e.g., in the compose box
  and search.
* Otherwise, such a user will be displayed as an **Unknown user** in the Grow Team
