...
By default, Grow Team stores messages indefinitely, allowing full-text
search of your complete history.

Grow Team supports configuring both a global organization-level message
...
* Deleted messages are preserved temporarily in a special archive.  So
  ...
  meant to preserve, contact your server administrator promptly for assistance with
  restoration.  See the [deletion
  documentation](/help/delete-a-message#delete-a-message-completely) for
  more details on precisely how message deletion works in Grow Team.
