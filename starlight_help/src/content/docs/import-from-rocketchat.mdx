...
You can import your current workspace into a Grow Team organization. It's a great
way to preserve your workspace history when you migrate to Grow Team, and to make
...
To import your Rocket.Chat organization into Grow Team, you will need to take the
following steps, which are described in more detail below:

<Steps>
  1. [Export your Rocket.Chat data](#export-your-rocketchat-data).
  1. [Import your Rocket.Chat data into Grow Team](#import-your-data-into-zulip).
  1. [Get your organization started with Grow Team](#get-your-organization-started-with-zulip)!
</Steps>

<span id="import-your-organization-from-rocketchat-into-zulip" aria-hidden="true"></span>

## Import your organization from Rocket.Chat into Grow Team

### Export your Rocket.Chat data

Rocket.Chat does not provide an official data export feature, so the Grow Team
...
* Rocket.Chat does not export workspace settings, so you will need to [configure
  the settings for your Grow Team organization](/help/customize-organization-settings).
...
* Rocket.Chat user roles are mapped to Grow Team's [user
  roles](/help/user-roles) in the following way:
  | Rocket.Chat role | Grow Team role |
  | ---------------- | ---------- |
  | Admin            | Owner      |
  | User             | Member     |
  | Guest            | Guest      |
...
* Messages longer than Grow Team's limit of 10,000 characters are not
  imported.
* Livechat channels/messages are not imported.
* Messages from Rocket.Chat Discussions are imported as topics
  inside the Grow Team channel corresponding to the parent channel of the
