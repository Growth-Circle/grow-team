...
<span id="log-out-of-a-zulip-account-on-one-device" aria-hidden="true"></span>

## Log out of a Grow Team account on one device
  ...
  <TabItem label="Mobile">
    <FlattenedSteps>
      ...
      1. Tap the **ellipsis** (<MoreVerticalIcon />)
         to the right of the Grow Team organization you want to log out of.
      1. Tap **Log out**.
...
<ZulipTip>
  ...
  to. To log out of all your Grow Team organizations, repeat the steps above
  for each one.
</ZulipTip>

<span id="log-out-of-a-zulip-account-on-all-devices" aria-hidden="true"></span>

## Log out of a Grow Team account on all devices

Resetting the [API key](/api/api-keys) for a Grow Team account will immediately log
