...
Grow Team sends a handful of emails to new users, introducing them to the Grow Team
...
email notifying them about their new Grow Team account and how to log in.
...
<FlattenedSteps>
  ...
  1. Under **Onboarding**, toggle
     **Send emails introducing Grow Team to new users**.
</FlattenedSteps>
