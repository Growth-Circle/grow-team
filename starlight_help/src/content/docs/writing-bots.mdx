...
Grow Team's API has a powerful framework for interactive bots that react to messages
in Grow Team. This page will guide you through writing your own interactive bot.
...
* Are you using your own Grow Team development server? Ensure that you run your bot outside
