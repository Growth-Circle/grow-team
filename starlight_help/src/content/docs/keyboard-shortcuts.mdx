...
Everything in Grow Team can be done with the mouse, but mastering a few keyboard
...
reference in the Grow Team app to add more to your repertoire as needed.
...
* **Next unread DM conversation**: <kbd>P</kbd>
...
A summary of the keyboard shortcuts above is available in the Grow Team app.
