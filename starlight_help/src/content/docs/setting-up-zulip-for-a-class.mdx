---
title: Setting up Grow Team for a class
---
...
Welcome to Grow Team! This page will guide you through setting everything
up for [teaching with Zulip](https://zulip.com/for/education/). If you
are using Grow Team for a different purpose, we recommend checking out the
[moving to Grow Team](/help/moving-to-zulip) guide instead.

If you are a student, or if your Grow Team organization is already set up,
you can proceed to the [Using Grow Team for a
...
<span id="trying-out-zulip" aria-hidden="true"></span>

## Trying out Grow Team

Use channels and topics to share lecture notes, answer questions, and coordinate with teaching staff.
Ask your Grow Team administrator for access to a classroom organization.
Try the workflow with a small group before inviting the whole class.

## Choosing between Zulip Cloud and self-hosting

Grow Team currently uses a self-hosted installation. Ask the operator about capacity, backups, and account policies before adding a class.
[Zulip Cloud](https://zulip.com/zulip-cloud/) is a separate upstream service with its own terms and pricing.

<span id="do-i-need-a-separate-zulip-organization-for-each-class" aria-hidden="true"></span>

## Do I need a separate Grow Team organization for each class?

There are a few ways to set up Grow Team, and different ones may be convenient for your needs:

* If your **school or department already has a Grow Team organization**,
  you will probably find it easiest to just add your class to
  it. Advantages:
  * Students and staff can use a single Grow Team account for all classes.
  * You can create department-wide channels, e.g., for announcing talks or other events.
  * You don’t need to set up a separate server if you’re self-hosting Grow Team.
* You can **set up a separate Grow Team organization for each class**
  ...
  * You can easily switch between multiple Grow Team organizations in
    the [compatible desktop clients](/apps/).
* You can **use a single Grow Team organization for several classes**
  you’re teaching, perhaps re-purposing a Grow Team organization from a
...
If you change your mind down the line, you can rename your Grow Team
...
registration and login page for your organization, and in the Grow Team app.
...
Grow Team offers [several levels of permissions based on user
roles](/help/user-roles). Here are some recommendations for
how to assign roles and permissions for a class.

<span id="recommended-roles-and-permissions-for-a-single-class-zulip-organization" aria-hidden="true"></span>

#### Recommended roles and permissions for a single-class Grow Team organization
...
* If you are [using a single Grow Team organization][separate-orgs] for
...
<ZulipTip>
  If using your Grow Team organization for a single class, set default
...
to [Getting started with Grow Team][getting-started] and the guide to
...
Grow Team integrates directly with dozens of products, and with hundreds
more through [Zapier](/integrations/zapier) and
[IFTTT](/integrations/ifttt).  Popular Grow Team integrations include
...
If you plan to use the same Grow Team organization in future terms (either
...
* You may choose to [deactivate students’ Grow Team
  accounts][deactivate-user] when the class is over.
* [Unpin channels](/help/pin-a-channel) from the class from your
  personal view.

If you do not plan to reuse the Grow Team organization, you can instead:
