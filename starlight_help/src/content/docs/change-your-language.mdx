...
<span id="change-the-language-of-the-zulip-app" aria-hidden="true"></span>

## Change the language of the Grow Team app
...
Grow Team uses the Source Sans 3 font, which [supports over 30 languages][adobe-docs].
