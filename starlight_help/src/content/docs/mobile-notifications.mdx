...
Grow Team can be configured to send [mobile](/help/mobile-app-install-guide)
...
message was sent) are not visible to Apple, Google, or Grow Team's
...
for encryption protocol details.
...
You can customize whether or not Grow Team will send mobile push
notifications while you are actively using one of the Grow Team apps.
...
Next, test Grow Team push notifications on your mobile device.
...
<Tabs>
  <TabItem label="Mobile">
    <Steps>
      ...
      1. If your Grow Team organization is self-hosted (not at `*.zulipchat.com`),
      ...
      1. Ask *another* user (not yourself) to [send you a direct
         message](/help/starting-a-new-direct-message). You should see a Grow Team message
...
delivery of mobile notifications to apps like Grow Team. If you're having issues
with Grow Team notifications on your Android phone, we recommend Signal's excellent
...
<Steps>
  1. Your server administrator needs to register your Grow Team server with the
