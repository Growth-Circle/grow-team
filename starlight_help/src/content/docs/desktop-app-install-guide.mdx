...
Grow Team does not provide a desktop app. The instructions below describe the
upstream Zulip Desktop client. Use it only when your administrator confirms it
is compatible with this Grow Team server.
