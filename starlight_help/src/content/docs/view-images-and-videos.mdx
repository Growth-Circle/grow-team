  ...
  <TabItem label="Desktop/Web">
    <Steps>
      ...
      1. You can interact with the video.
         ...
         * **Download** the video if it was uploaded to Grow Team
  ...
  <TabItem label="Mobile">
    <Steps>
      1. Tap a video thumbnail, link, or file name to open the video in your device's
         default browser.
      1. You can switch back to the Grow Team app once you are done.
    </Steps>
  </TabItem>
</Tabs>
...
In the Grow Team web app, you can browse images and videos in
