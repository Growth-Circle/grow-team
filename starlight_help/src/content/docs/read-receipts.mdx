...
With privacy in mind, Grow Team lets you [control][configure-personal-read-receipts]
...
<span id="configure-whether-zulip-lets-others-see-when-youve-read-messages" aria-hidden="true"></span>

## Configure whether Grow Team lets others see when you've read messages

Grow Team supports the privacy option of never sharing whether or not you have read
