...
Grow Team makes it possible to move messages, or an entire topic, to another
...
history](/help/channel-permissions#private-channels), Grow Team determines whether
