...
Grow Team automatically keeps track of which messages you have and haven't read.
Unread messages have a line along the left side, which fades when the message
gets marked as read.

Grow Team offers tools to manually mark one or more messages as read, and you can
...
You can choose how messages are automatically marked as read in the Grow Team web
...
* **Only in conversation views**: In Grow Team, a **conversation** is a [direct
