...
Grow Team lets you delete the content of your messages or delete messages completely
...
Grow Team's [edit history](/help/view-a-messages-edit-history) feature.  This can be
...
messages will immediately disappear from the UI in all official Grow Team clients.
...
time, they are permanently and irrecoverably deleted from the Grow Team
