...
By default, Grow Team requests a generally-accepted certificate during the
...
which case your Grow Team server may be using a self-signed
certificate. This is most common for Grow Team servers not connected to
the public internet.

## Web

Most browsers will show a warning if you try to connect to a Grow Team server
with a self-signed certificate.

If you are absolutely, 100% sure that the Grow Team server you are connecting to
...
give a stranger full access to your Grow Team account, including your
