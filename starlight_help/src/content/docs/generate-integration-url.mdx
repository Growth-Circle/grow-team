...
Many [Grow Team integrations](/integrations/) are webhooks. An incoming webhook
integration allows a third-party service, such as an [issue
tracker](/integrations/github) or an [alerting
tool](/integrations/pagerduty), to post updates to Grow Team. To configure
where these updates will be posted, you need to generate a special Grow Team
integration URL.
