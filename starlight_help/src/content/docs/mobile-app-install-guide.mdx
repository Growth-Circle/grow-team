...
Grow Team does not provide mobile apps. The instructions below describe
upstream Zulip mobile clients. Use them only when your administrator confirms
they are compatible with this Grow Team server.
