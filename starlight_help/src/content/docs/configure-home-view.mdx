...
The home view in Grow Team is the view you reach after logging in
to the Grow Team web app. You can also navigate to the home view via
keyboard shortcuts.

The home views available in Grow Team are
[**Inbox**](/help/inbox),
...
<FlattenedSteps>
  ...
  1. Under **Navigation**, click on the **Home view** dropdown
     and select a view.
  1. To see your changes in action, open a new Grow Team tab, or use a keyboard
...
Grow Team has a number of [keyboard shortcuts](/help/keyboard-shortcuts)
...
This will not disable other <kbd>Esc</kbd> key shortcuts used in Grow Team,
