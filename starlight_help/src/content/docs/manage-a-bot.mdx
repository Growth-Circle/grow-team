...
Grow Team lets you manage the properties of any bot for which you are the owner.
...
## Download the bot configuration file
...
Only the owner of an outgoing or incoming webhook bot has access to its
configuration file.
...
<FlattenedSteps>
  ...
  1. In the **Actions** column, click the **manage bot** (<UserCogIcon />) icon,
     and scroll down to **Bot configuration file**.
