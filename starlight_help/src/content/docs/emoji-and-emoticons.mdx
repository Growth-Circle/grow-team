...
<Tabs>
  ...
  <TabItem label="Via paste">
    <FlattenedSteps>
      ...
      1. Paste an emoji copied from outside of Grow Team directly into the compose box.
    </FlattenedSteps>
  </TabItem>
</Tabs>
...
You can configure Grow Team to convert emoticons into emoji, so that, e.g., `:)`
...
<Tabs>
  ...
  <TabItem label="Via paste">
    <Steps>
      1. [Start a new topic](/help/introduction-to-topics#how-to-start-a-new-topic).
      1. Paste an emoji copied from outside of Grow Team directly into the text input box.
    </Steps>
...
you send. Grow Team emoji are compatible with screen readers and other accessibility tools.
