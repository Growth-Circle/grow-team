...
<Tabs>
  <TabItem label="Via drag-and-drop">
    <FlattenedSteps>
      1. Drag and drop one or more files anywhere in the Grow Team app,
  ...
  <TabItem label="Android">
    <Steps>
      1. In another mobile app, select text or one or more files, and tap the
         **share** button.
      1. Tap the **Grow Team** (<img src={ZulipIconCircle.src} alt="logo" class="help-center-icon" />) logo to share to Grow Team.
