...
When you create a Grow Team account using an email address already associated with
an account in another Zulip organization, on Zulip Cloud or the same self-hosted
Grow Team installation, you can import your user settings from an existing account.
...
<Steps>
  1. Follow the instructions for [joining a Grow Team organization](/help/join-a-zulip-organization).
  1. From the dropdown list under **Import settings from an existing Grow Team account**,
...
* [Joining a Grow Team organization](/help/join-a-zulip-organization)
