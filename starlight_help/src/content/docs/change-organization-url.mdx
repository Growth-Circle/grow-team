...
Grow Team supports changing the URL for an organization. Users who navigate to the
...
If you're self-hosting, you can change the root domain of your Grow Team
...
In addition to configuring Grow Team as detailed here, you also need to
