...
Here is an overview of all the information and actions you can take in Grow Team's
compose box.
...
When composing a message, Grow Team lets you view a different
...
Grow Team lets you jump to the [conversation](/help/reading-conversations) you're
currently composing to.

<Steps>
  1. [Open the compose box](/help/open-the-compose-box).
  1. Click the highlighted **go to conversation** (<ChevronRightIcon />) button at
     the top of the compose box. It will be clickable only if you're viewing a
     different conversation from the one you are composing to.
</Steps>
