...
Grow Team supports many types of profile fields, such as dates, lists of options,
...
You can [configure](#use-a-custom-profile-field-in--mention-suggestions)
**External account** and **Short text** custom profile fields to be used for
[@-mention](/help/mention-a-user-or-group) suggestions. For example, users could
be mentioned by their GitHub or Mastodon usernames.

Grow Team supports synchronizing custom profile fields from an external
...
All field types other than "Person" have a checkbox option
...
banner every time they open the Grow Team web or desktop app prompting them to fill
it out.
...
[@-mention](/help/mention-a-user-or-group) suggestions.
...
* **External account**: For linking to an external account (e.g., GitHub,
  ...
  [configure](#use-a-custom-profile-field-in--mention-suggestions) this field to
  be used for [@-mention](/help/mention-a-user-or-group) suggestions. Some
  integrations ([Bitbucket](/integrations/bitbucket),
  [GitHub](/integrations/github), [GitLab](/integrations/gitlab),
  [Jira](/integrations/jira)) use [silent
...
* **Short text**: For one-line responses up to 50 characters (e.g., team name or
  ...
  [configure](#use-a-custom-profile-field-in--mention-suggestions) this field to
  be used for [@-mention](/help/mention-a-user-or-group) suggestions.
