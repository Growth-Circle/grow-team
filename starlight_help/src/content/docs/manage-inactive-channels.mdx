...
To avoid clutter in the [left sidebar](/help/left-sidebar), Grow Team automatically
hides channels with no recent messages if you're subscribed to 20+ channels. You
can [configure](#configure-hiding-inactive-channels) Grow Team to show or hide
