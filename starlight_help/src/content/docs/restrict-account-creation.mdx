...
Each Grow Team account is associated with an email address. If your organization
...
Grow Team provides a number of configuration options to control who can create a new
