...
Grow Team uses the time zone configured on your computer or mobile device for
...
computer's time zone, the Grow Team web and desktop apps display a banner offering
...
<span id="configure-time-zone-used-by-zulip-to-display-dates-and-times" aria-hidden="true"></span>

## Configure time zone used by Grow Team to display dates and times
...
If you local time in Grow Team differs from your device's time zone (for example,
