...
Grow Team offers a range of font size options, from 12 to 20, to make the UI
...
the a compatible desktop client.
...
<Tabs>
  <TabItem label="Desktop/Web">
    ...
    <ZulipTip>
      In the a compatible desktop client and most browsers, you can also open the **View**
