...
as needed. To add permissions, use the dedicated permissions management panel
for [your organization](/help/manage-permissions), or the
[channel](/help/channel-permissions) or [group](#configure-group-permissions)
you're adding permissions for.
