...
To import your Mattermost organization into Grow Team, you will need to take the
following steps, which are described in more detail below:

<Steps>
  1. [Export your Mattermost data](#export-your-mattermost-data).
  1. [Import your Mattermost data into Grow Team](#import-your-data-into-zulip).
  1. [Get your organization started with Grow Team](#get-your-organization-started-with-zulip)!
</Steps>

<span id="import-your-organization-from-mattermost-into-zulip" aria-hidden="true"></span>

## Import your organization from Mattermost into Grow Team
  ...
  <TabItem label="Self-hosted">
    ...
    <FlattenedSteps>
      ...
      1. To import into an organization hosted on the root domain
         (`EXTERNAL_HOST`) of the Grow Team installation, run the following commands,
         ...
         ```
         By default Mattermost teams will be converted into their own Grow Team organizations,
         to convert all Mattermost teams into one Grow Team organization, run:
         ```bash
         ...
         <ZulipNote>
           **Note**: With the `--combine-teams-into-one-org` option, admins in individual Mattermost
           teams will be converted into admin users in the combined Grow Team organization.
         </ZulipNote>
...
* Mattermost's user roles are mapped to Grow Team's [user
  roles](/help/user-roles) in the following way:
  | Mattermost role    | Grow Team role |
  | ------------------ | ---------- |
