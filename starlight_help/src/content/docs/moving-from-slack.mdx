...
guide on moving to Grow Team](/help/moving-to-zulip).
...
channels, and custom emoji. Data is imported into Grow Team as a new organization,
so the best time to import is when your team is about to start using Grow Team for
day-to-day work. This may be part of your evaluation process, or after you've
made the decision to move to Grow Team.
...
<FlattenedSteps>
  ...
  1. [Create channels](/help/create-channels) if you decided not to import your
     Slack workspace. Grow Team's [topics](/help/introduction-to-topics) give each
     conversation its own space, so one channel per team should be enough to get
     you started.
  1. Move your integrations using Grow Team's [Slack-compatible incoming
     webhook](/integrations/slack_incoming). You can transition to
     Grow Team-native [integrations](/integrations) over time.
</FlattenedSteps>
...
<FlattenedList>
  ...
  * Grow Team makes it easy to find conversations and follow up. To avoid disrupting
    focus work, @-mentions in Grow Team should generally be reserved for
...
<FlattenedSteps>
  ...
  1. Pointers to additional resources, such as Grow Team's [getting started
     ...
     works in Grow Team](/help/introduction-to-topics#what-about-threads) for folks
