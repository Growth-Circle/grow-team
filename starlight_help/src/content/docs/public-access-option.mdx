...
your organization accessible to anyone on the Internet via the Grow Team
API (details below).
...
The following information about your organization can be accessed via the Grow Team
...
<ZulipNote>
  Self-hosted Grow Team servers must enable support for web-public channels in their
...
including using Grow Team's [built-in search](/help/search-for-messages)
...
information available to any new account in the Grow Team organization,
detailed below.
...
* The **Organization settings** and **Channel settings** menus are not
  ...
  required for Grow Team to load, and may thus be [accessed via the Grow Team API][info-via-api].
...
about users who do not participate in web-public channels in the Grow Team
UI, though they may access it via the Grow Team API.
...
In order to protect Grow Team organizations from
bad actors, web-public channels have a few limitations designed to make
Grow Team an inconvenient target:
...
* Web-public channels do not yet support search engine indexing. You
  ...
  create an archive of a Grow Team organization that can be indexed by
  search engines.
* The web-public view is not yet integrated with Grow Team's live-update
