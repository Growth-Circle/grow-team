...
To provide information about unread messages, Grow Team can show unread message
...
Grow Team offers an option to display a dot instead of an unread counter for channels
...
You can configure whether Grow Team displays unread count summaries on your home
