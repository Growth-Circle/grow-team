...
Grow Team can be configured to send message notification emails for [DMs, mentions,
...
[active](/help/status-and-availability#availability) on Grow Team. Messages sent to
...
You can reply to Grow Team messages by replying to message notification emails.
...
You can configure whether the name of your Grow Team organization is included in the
subject of message notification emails.

Grow Team offers a convenient **Automatic** configuration option, which includes the
...
Grow Team messages from your email. Organization administrators can do this at an
...
By default, Grow Team sends an email whenever you log in to Grow Team. These emails
...
In typical usage, these emails are sent infrequently, since all Grow Team apps
...
Grow Team sends out a low-traffic newsletter (expect 2-4 emails a year)
...
<Tabs>
  <TabItem label="Zulip Cloud">
    <FlattenedSteps>
      ...
      1. Under **Other emails**, toggle
         **Send me Grow Team's low-traffic newsletter (a few emails a year)**.
    </FlattenedSteps>
  </TabItem>
</Tabs>
