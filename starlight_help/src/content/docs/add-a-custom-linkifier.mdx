...
that matches the linkifier into the compose box, Grow Team will automatically
convert it to linked text (e.g., `https://github.com/zulip/zulip/issues/2468`
becomes `#2468`).

If a linkifier pattern (e.g., `#2468`) appears in the name of a topic, Grow Team adds
an **open** (<ExternalLinkIcon />) button to the right of the topic in the
message recipient bar that links to the appropriate URL.

If you have any trouble creating the linkifiers you want, please [contact Grow Team
...
This example pattern is a shorthand for linking to pages on Grow Team's ReadTheDocs
site.
