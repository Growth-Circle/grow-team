...
When you go to a message feed in the Grow Team web or desktop app, you'll generally
...
* **First unread message in conversation views, newest message elsewhere**: In
  Grow Team, a **conversation** is a [direct message](/help/direct-messages) thread
