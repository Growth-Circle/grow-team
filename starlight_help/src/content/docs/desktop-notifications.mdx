...
Grow Team can be configured to send visual and audible desktop notifications for
...
You can select the sound Grow Team uses for audible desktop notifications. Choosing
...
By default, Grow Team displays a count of your unmuted unread messages on the
...
Desktop notifications are triggered when a message arrives, and Grow Team is not
in focus or the message is offscreen. You must have Grow Team open in a browser
tab or in the a compatible desktop client to receive desktop notifications.
...
notifications for new messages, check your Grow Team notification settings. Make
...
notifications from Grow Team. Before checking Grow Team-specific settings, make sure
that **Do Not Disturb mode** is not enabled on your computer.

<Tabs>
  <TabItem label="Chrome">
    <Steps>
      1. Click on the site information menu to the left of the URL for your Grow Team
         organization.
    ...
    <Steps>
      ...
      1. Paste the Grow Team URL for your organization into the site field, and
         click **Add**.
    </Steps>
  </TabItem>
  ...
  <TabItem label="Firefox">
    <Steps>
      ...
      1. Find the URL for your Grow Team organization, and adjust the **Status**
         selector to **Allow**.
    </Steps>
  </TabItem>
  ...
  <TabItem label="Desktop app">
    **Windows**
    ...
    <Steps>
      ...
      1. Select **Zulip** from the list of apps for the compatible upstream client.
      1. Configure the notification style for the compatible upstream client.
    </Steps>
