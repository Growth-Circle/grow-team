...
Grow Team lets you follow topics you are interested in, which helps you see when you
...
<Tabs>
  ...
  <TabItem label="Left sidebar">
    <FilterFollowedLeftSidebar />
  </TabItem>
</Tabs>
