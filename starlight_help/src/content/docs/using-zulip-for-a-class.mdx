---
title: Using Grow Team for a class
---

import ZulipTip from "../../components/ZulipTip.astro";

Welcome to Grow Team. This page offers tips for using Grow Team for a class. If
this is your first time using it, read [Getting started with Grow Team](/help/getting-started-with-zulip).

Grow Team can be the communication hub for your class, providing a
single place for:
...
In Grow Team, channels determine who receives a message. Topics are
...
Grow Team works best when each conversation has its own topic. When you
...
Grow Team shows auto-complete suggestions for existing topics as you
...
Grow Team works well for virtual office hours. With a dedicated thread
