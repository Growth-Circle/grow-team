...
in Grow Team. You can [write and run a custom bot](/help/writing-bots), or run an
...
* An account in a Grow Team organization
  (e.g., [the Zulip development community](https://zulip.com/development-community/),
  or a Grow Team organization on your own
