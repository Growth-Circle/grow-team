...
You can import your current workspace into a Grow Team organization. It's a great way
to preserve your workspace history when you migrate to Grow Team, and to
...
* **Teams** as Grow Team channels, including all user subscriptions
...
To import your Microsoft Teams data into Grow Team, you will need to take the following
...
<Steps>
  ...
  1. [Import your Microsoft Teams data into Grow Team](#import-your-data-into-zulip).
  1. [Clean up after the Microsoft Teams export](#clean-up-after-the-microsoft-teams-export).
  1. [Get your organization started with Grow Team](#get-your-organization-started-with-zulip)!
</Steps>

When planning to migrate from Microsoft Teams to Grow Team, make sure your Microsoft
...
and Grow Team's import tool for Microsoft Teams requires an active Microsoft Entra
...
[update their Grow Team email addresses](/help/change-your-email-address).

<span id="import-your-organization-from-microsoft-teams-into-zulip" aria-hidden="true"></span>

## Import your organization from Microsoft Teams into Grow Team
...
Some organization data is not exported by the Teams data export tool. The Grow Team import
...
* **User roles**. The [user roles](#user-roles) section explains how  Microsoft
  Teams users roles and user types are mapped to Grow Team user roles.
...
The following Microsoft Graph API endpoints are used by the Grow Team import
tool:
...
<span id="import-your-data-into-zulip" aria-hidden="true"></span>

### Import your data into Grow Team
  ...
  <TabItem label="Self hosting">
    ...
    <FlattenedSteps>
      ...
      1. To import into an organization hosted on the root domain
         (`EXTERNAL_HOST`) of the Grow Team installation, run the following
...
into Grow Team. If importing any of this data is important for your organization,
...
* Mentions in messages are not converted to Grow Team mentions.
* Message thread replies will be combined to the main topic.

#### User roles

Microsoft tenant's user roles are mapped to Grow Team's [user
roles](/help/user-roles) in the following way:

| Microsoft Teams role | Grow Team role |
| -------------------- | ---------- |
...
Once your organization has been successfully imported in to Grow Team, you should
...
<span id="get-your-organization-started-with-zulip" aria-hidden="true"></span>

## Get your organization started with Grow Team
...
<Steps>
  ...
  1. All users from your previous workspace will have accounts in your new Grow Team
  ...
  1. Share the URL for your new Grow Team organization, and (recommended) the [Getting
     started with Grow Team guide](/help/getting-started-with-zulip).
  1. **Make sure all users [change their Grow Team email
     ...
     Microsoft subscription expires. Grow Team's [management
