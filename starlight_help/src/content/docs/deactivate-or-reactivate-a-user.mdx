...
* The user will be immediately logged out of all Grow Team sessions, including
...
* You can choose whether to delete the user's name, profile picture,
  and messages they've sent (e.g., their DMs or channel messages).

<ZulipNote>
  You must go through the deactivation process below to fully remove a user's
  access to your Grow Team organization. Changing a user's password or removing
  their single sign-on account will not log them out of their open Grow Team
