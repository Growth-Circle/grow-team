...
By default, anyone other than guests can add a bot to a Grow Team organization.
...
[`zuliprc` configuration file](/help/manage-a-bot#download-the-bot-configuration-file).
