...
* Using the Zulip Botserver, which is a simple Flask server for
  running a bot in production, and connecting that to Grow Team's outgoing
  webhooks feature.

## Zulip Botserver

The upstream Zulip Botserver is compatible with Grow Team. It can:

* Run bots in production.
* Run multiple bots at once.

The Zulip Botserver is a Python (Flask) server that implements Grow Team's
...
from your main Grow Team server. The sequence of events in a successful
...
<Steps>
  ...
  1. The Grow Team server sends a POST request to your Botserver endpoint URL:
     ...
     This URL is configured in the Grow Team web-app in your Bot User's settings.
...
<span id="create-a-bot-in-your-zulip-organization" aria-hidden="true"></span>

### Create a bot in your Grow Team organization
...
<Steps>
  1. [Create your bot](#create-a-bot-in-your-zulip-organization) in your Grow Team
     organization.
...
<Steps>
  1. [Create your bots](#create-a-bot-in-your-zulip-organization)
     in your Grow Team organization.
...
* Your Botserver needs to be accessible from your Grow Team server over
  ...
  If your Grow Team server is self-hosted, you can test by running `curl
