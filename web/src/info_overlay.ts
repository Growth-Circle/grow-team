...
const markdown_help_rows = [
    ...
    {
        markdown: `[${$t({defaultMessage: "Grow Team website"})}](https://github.com/Growth-Circle/grow-team)`,
...
<div class="codehilite zulip-code-block" data-code-language="Python"><pre><div class="code-buttons-container">
    ...
    <span class="nb">print</span><span class="p">(</span><span class="s2">"Grow Team"</span><span class="p">)</span>
</code></pre></div>`,
    },
    {
        markdown: $t(
